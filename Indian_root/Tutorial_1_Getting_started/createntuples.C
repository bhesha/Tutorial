...
//     (Wed Jun  7 13:47:11 2023 by ROOT version6.22/06)
//   from TTree rho0_Tree/rho0_Tree
//   found on file: Flat_testout.root
//////////////////////////////////////////////////////////
//////  1) root Flat_testout.root 
/////   2)rho0_Tree->MakeCode("Analyze3")
////This code is auto generated

//Reset ROOT and connect tree file
   gROOT->Reset();
   TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Flat_testout.root");
   if (!f) {
      f = new TFile("Flat_testout.root");
   }
    f->GetObject("rho0_Tree",tree);
...
// rho0_Tree->SetBranchStatus("*",0);  // disable all branches
// TTreePlayer->SetBranchStatus("branchname",1);  // activate branchname

   Long64_t nentries = rho0_Tree->GetEntries();

   Long64_t nbytes = 0;
//   for (Long64_t i=0; i<nentries;i++) {
//      nbytes += rho0_Tree->GetEntry(i);
//   }
}
