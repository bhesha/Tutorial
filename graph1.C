...
int graph1() {
  ...
  double x[nPoints] = {15, 28, 30, 33, 35, 47, 67, 108, 112, 137};
  double y[nPoints] = {12, 14, 15, 23, 34, 55, 37,48, 34,56};
  double yErr[nPoints] = {1.0, 2.0, 1.5, 2.5, 5.0, 11, 3.0 ,14.0 ,5.0 ,6.0 };  // Define errors for y values
